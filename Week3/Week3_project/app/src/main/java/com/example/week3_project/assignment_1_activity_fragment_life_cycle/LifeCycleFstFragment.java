...
import com.example.week3_project.assignment_1_activity_life_cycle.NewActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.do_start_new_activity_in_frag:
                Intent startNewActivityInFrag = new Intent(getActivity(), NewActivity.class);
                startActivity(startNewActivityInFrag);
                break;
        }
    }
}
